...
fn decode_bitmap_record(
    ...
    let x_resolution = reader.read_compressed_unsigned_long()?;
    let y_resolution = reader.read_compressed_unsigned_long()?;
    let planes = reader.read_compressed_unsigned_short()?;
    let bit_count = reader.read_compressed_unsigned_short()?;
    let width = reader.read_compressed_unsigned_long()?;
    let height = reader.read_compressed_unsigned_long()?;
    let clr_used = reader.read_compressed_unsigned_long()?;
    let clr_important = reader.read_compressed_unsigned_long()?;
    let compressed_size = usize::try_from(reader.read_compressed_unsigned_long()?)
        .map_err(|_| HlpError::invalid("WinHelp bitmap", "compressed size does not fit usize"))?;
    let hotspot_size = reader.read_compressed_unsigned_long()?;
...
fn decode_metafile_record(
    ...
    let mapping_mode = i32::from(reader.read_compressed_unsigned_short()?);
    ...
    let decompressed_size = usize::try_from(reader.read_compressed_unsigned_long()?)
